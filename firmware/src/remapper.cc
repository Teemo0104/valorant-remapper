...
// ============================================================
// VALORANT 弹道表（数据基于游戏内灵敏度 = 1 录制）
// 若你的游戏内灵敏度为 S，请在配置工具把"灵敏度倍率"设为 1/S。
// ============================================================
// 战神
static const TrackPoint ARES[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15},
    {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15},
    {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15},
    {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15},
    {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15},
    {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {2,1,15}, {0,0,15}, {0,0,15}, {1,0,15}, {1,1,15}, {1,1,15},
    {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15},
    {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15},
    {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15},
    {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15},
    {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15},
    {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15},
    {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15},
    {0,0,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,1,15}, {0,1,15}, {1,0,15}, {1,0,15},
    {1,0,15}, {1,1,15}, {1,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {1,1,15}, {1,0,15}, {1,0,15},
    {1,0,15}, {1,1,15}, {1,1,15}, {1,0,15}, {1,0,15}, {1,0,15}, {1,1,15}, {1,1,15}, {1,0,15}, {1,0,15},
    {1,0,15}, {1,1,15}, {1,1,15},
};

// 獠犬
static const TrackPoint JUDGE[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,1,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,1,15}, {0,1,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,1,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,0,15}, {0,0,15},
...
// 狂徒
static const TrackPoint VANDAL[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19},
    {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,2,19}, {0,3,19}, {0,3,19},
    {0,2,19}, {0,2,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,4,19}, {0,4,19},
    {0,3,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,4,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,3,19}, {0,4,19},
    {0,0,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,1,19},
    {0,0,19}, {0,0,19}, {0,1,19}, {0,1,19}, {0,1,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
    {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19}, {0,0,19},
};

// 狂怒
static const TrackPoint FRENZY[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
...
// 幻影
static const TrackPoint PHANTOM[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18},
    {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18},
    {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,2,18}, {0,3,18}, {0,3,18}, {0,4,18}, {0,4,18}, {0,4,18},
    {0,3,18}, {0,3,18}, {0,3,18}, {0,4,18}, {0,4,18}, {0,3,18}, {0,3,18}, {0,3,18}, {0,3,18}, {0,4,18},
    {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18}, {0,1,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {3,0,18}, {3,0,18}, {3,0,18}, {3,0,18}, {3,0,18},
    {3,0,18}, {3,0,18}, {3,0,18}, {3,0,18}, {3,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18}, {0,0,18},
    {0,0,18}, {0,0,18}, {0,0,18}, {1,0,18}, {1,0,18}, {1,0,18}, {2,0,18}, {2,0,18}, {2,0,18}, {2,0,18},
    {1,0,18}, {1,0,18}, {2,0,18}, {2,0,18}, {2,0,18}, {0,0,18}, {0,0,18}, {1,0,18}, {1,0,18}, {1,0,18},
};

// 骇灵
static const TrackPoint SPECTRE[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
    {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15}, {0,2,15},
...
// 蜂刺
static const TrackPoint STINGER[] = {
    {0,0,3}, {0,0,3}, {0,0,3}, {0,0,3}, {0,0,3}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,1,12}, {0,1,12}, {0,1,12}, {0,2,12}, {0,2,12}, {0,1,12}, {0,1,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,3,12}, {0,3,12}, {0,3,12}, {0,3,12}, {0,3,12}, {0,3,12}, {0,4,12},
    {0,3,12}, {0,3,12}, {0,4,12}, {0,4,12}, {0,4,12}, {0,3,12}, {0,3,12}, {0,4,12}, {0,4,12}, {0,4,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,1,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,1,12}, {0,1,12}, {0,1,12}, {1,1,12}, {1,2,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12},
    {0,0,12}, {0,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {1,0,12}, {1,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
};

// 奥丁
static const TrackPoint ODIN[] = {
    {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,0,5}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12},
    {0,2,12}, {0,2,12}, {0,2,12}, {0,2,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,1,12},
    {1,0,12}, {1,1,12}, {1,1,12}, {1,1,12}, {2,1,12}, {1,0,12}, {1,1,12}, {1,1,12}, {1,1,12}, {2,1,12},
    {1,0,12}, {1,1,12}, {1,1,12}, {1,1,12}, {2,1,12}, {1,0,12}, {1,1,12}, {1,1,12}, {1,1,12}, {2,1,12},
    {1,0,12}, {1,1,12}, {1,1,12}, {1,1,12}, {2,1,12}, {1,0,12}, {1,0,12}, {1,1,12}, {1,1,12}, {2,1,12},
    {1,0,12}, {1,0,12}, {1,1,12}, {1,1,12}, {2,1,12}, {1,0,12}, {1,0,12}, {1,1,12}, {1,1,12}, {2,1,12},
    {1,0,12}, {1,0,12}, {1,1,12}, {1,1,12}, {2,1,12}, {1,0,12}, {1,0,12}, {1,1,12}, {1,1,12}, {2,1,12},
    {0,0,12}, {0,0,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,0,12}, {0,0,12}, {0,1,12}, {0,1,12}, {0,1,12},
    {0,0,12}, {0,0,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,0,12}, {0,1,12}, {0,1,12}, {0,1,12}, {0,1,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12},
    {1,0,12}, {1,0,12}, {1,0,12}, {1,0,12}, {2,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
    {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12}, {0,0,12},
...
constexpr uint16_t ARES_LEN    = sizeof(ARES)    / sizeof(ARES[0]);
constexpr uint16_t JUDGE_LEN   = sizeof(JUDGE)   / sizeof(JUDGE[0]);
constexpr uint16_t VANDAL_LEN  = sizeof(VANDAL)  / sizeof(VANDAL[0]);
constexpr uint16_t FRENZY_LEN  = sizeof(FRENZY)  / sizeof(FRENZY[0]);
constexpr uint16_t PHANTOM_LEN = sizeof(PHANTOM) / sizeof(PHANTOM[0]);
constexpr uint16_t SPECTRE_LEN = sizeof(SPECTRE) / sizeof(SPECTRE[0]);
constexpr uint16_t STINGER_LEN = sizeof(STINGER) / sizeof(STINGER[0]);
constexpr uint16_t ODIN_LEN    = sizeof(ODIN)    / sizeof(ODIN[0]);
...
void process_mapping(bool auto_repeat) {
    ...
    //
    // 枪 index 顺序：
    //   0 VANDAL  1 PHANTOM                                          (步枪)
    //   2 SPECTRE 3 STINGER                                          (冲锋枪)
    //   4 ARES    5 ODIN                                             (机枪)
    //   6 JUDGE                                                      (霰弹枪)
    //   7 FRENZY                                                     (手枪)
    // ============================================================
    {
        ...
        if (edge_l && armed >= 0 && !playing && !returning) {
            ...
            scale_cur = s;
            switch (armed) {
                case  0: cur = recoil::VANDAL;  cur_len = recoil::VANDAL_LEN;  break;
                case  1: cur = recoil::PHANTOM; cur_len = recoil::PHANTOM_LEN; break;
                case  2: cur = recoil::SPECTRE; cur_len = recoil::SPECTRE_LEN; break;
                case  3: cur = recoil::STINGER; cur_len = recoil::STINGER_LEN; break;
                case  4: cur = recoil::ARES;    cur_len = recoil::ARES_LEN;    break;
                case  5: cur = recoil::ODIN;    cur_len = recoil::ODIN_LEN;    break;
                case  6: cur = recoil::JUDGE;   cur_len = recoil::JUDGE_LEN;   break;
                case  7: cur = recoil::FRENZY;  cur_len = recoil::FRENZY_LEN;  break;
