...
static const TrackPoint AK47[] ={
    {0,0,3},{0,0,3},{0,0,2},{0,0,3},{0,0,2},{0,0,3},{0,0,2},{0,0,3},
    {0,0,2},{0,0,3},{0,0,2},{0,0,3},{0,0,9},{0,0,8},{0,0,8},{0,0,8},
    {0,0,9},{0,0,8},{0,0,8},{0,0,8},{0,0,9},{0,0,8},{0,0,8},{0,2,8},
    {0,4,9},{0,4,8},{0,3,8},{0,2,9},{0,1,8},{0,2,8},{0,2,9},{0,2,8},
    {0,1,8},{0,2,9},{0,2,8},{0,2,8},{0,2,9},{0,2,8},{0,2,8},{0,2,8},
    {0,2,9},{0,2,8},{0,2,8},{0,2,8},{-1,2,9},{0,2,8},{-1,2,8},{0,2,8},
    {0,4,9},{0,4,8},{0,2,8},{0,2,9},{0,2,8},{0,2,8},{0,2,9},{0,2,8},
    {0,3,8},{0,2,9},{-1,3,8},{0,2,8},{2,2,9},{3,2,8},{1,2,8},{1,2,9},
    {1,2,8},{1,2,8},{1,3,9},{1,2,8},{0,3,8},{1,2,9},{0,3,8},{1,2,8},
    {1,1,9},{1,1,8},{0,1,8},{1,1,8},{0,1,9},{1,2,8},{0,1,8},{1,2,8},
    {0,2,9},{1,2,8},{0,2,8},{1,1,8},{1,1,9},{1,1,8},{1,1,8},{1,1,9},
    {1,1,8},{1,1,8},{1,2,9},{1,1,8},{1,0,8},{1,1,9},{0,0,8},{1,1,8},
    {-5,1,9},{-5,1,8},{-1,1,8},{-1,1,8},{-1,1,9},{-1,1,8},{-1,1,8},{-1,1,8},
    {-2,1,9},{-1,1,8},{-2,2,8},{-1,1,8},{-6,-4,9},{-5,-3,8},{-5,0,8},{-4,-1,9},
    {-4,0,8},{-3,0,8},{-2,-1,9},{-3,0,8},{-3,0,8},{-3,-1,9},{-3,0,8},{-3,0,8},
    {-1,0,9},{0,1,8},{-1,0,8},{0,1,9},{-1,0,8},{0,1,8},{-1,1,9},{-1,0,8},
    {-2,1,8},{-2,1,9},{-1,0,8},{-2,1,8},{6,3,9},{6,2,8},{5,0,8},{1,1,8},
    {1,0,9},{1,1,8},{1,0,8},{1,1,8},{1,0,9},{1,1,8},{0,0,8},{1,1,8},
    {-5,-3,9},{-5,0,8},{-1,0,8},{-1,0,9},{-1,0,8},{-1,0,8},{-1,0,9},{-1,0,8},
    {-1,0,8},{-1,0,9},{-2,0,8},{-1,0,8},{-5,-2,9},{-2,-1,8},{-2,-1,8},{-2,-1,8},
    {-2,0,9},{-2,-1,8},{-1,0,8},{-2,-1,8},{-2,0,9},{-2,-1,8},{-2,0,8},{-2,-1,8},
    {4,4,9},{3,3,8},{0,0,8},{0,0,9},{0,1,8},{0,0,8},{0,1,9},{0,0,8},
    {0,1,8},{0,0,9},{0,1,8},{0,0,8},{6,0,9},{6,1,8},{6,0,8},{2,0,9},
    {3,0,8},{2,0,8},{3,1,9},{2,0,8},{3,1,8},{2,1,9},{3,0,8},{2,1,8},
    {1,0,9},{1,0,8},{1,0,8},{1,0,8},{1,1,9},{1,0,8},{1,1,8},{1,0,8},
    {1,1,9},{2,0,8},{1,1,8},{1,0,8},{0,0,9},{0,0,8},{0,0,8},{1,0,9},
    {1,0,8},{1,0,8},{1,0,9},{1,0,8},{1,1,8},{1,0,9},{1,1,8},{1,0,8},
    {2,-1,9},{2,0,8},{2,0,8},{2,0,8},{2,0,9},{2,0,8},{1,-1,8},{2,0,8},
    {1,0,9},{2,0,8},{1,0,8},{2,0,8},{4,-1,9},{4,-1,8},{4,0,8},{3,-2,9},
    {3,0,8},{2,-2,8},{2,0,9},{3,-1,8},{2,0,8},{2,-1,9},{3,0,8},{2,-1,8},
    {-5,0,9},{-5,0,8},{-5,0,8},{-1,0,9},{-2,1,8},{-1,0,8},{-2,1,9},{-1,0,8},
    {-2,1,8},{-1,0,9},{-2,1,8},{-1,0,8},{4,0,9},{3,0,8},{0,0,8},{1,0,8},
    {0,0,9},{0,0,8},{1,0,8},{0,0,8},{0,0,9},{1,0,8},{0,0,8},{0,0,8},
    {-3,0,9},{-3,0,8},{0,1,8},{-1,0,9},{0,1,8},{-1,0,8},{-1,1,9},{0,0,8},
    {-1,1,8},{-1,0,9},{0,1,8},{-1,0,8},{-2,0,9},{-2,0,8},{0,0,8},{-1,0,8},
    {0,0,9},{-1,0,8},{-1,0,8},{0,0,8},{-1,0,9},{-1,0,8},{0,1,8},{-1,0,8},
    {5,0,9},{5,0,8},{1,0,8},{2,0,9},{1,0,8},{1,0,8},{2,0,9},{1,0,8},
    {1,0,8},{2,0,9},{1,0,8},{1,0,8},{0,0,9},{0,0,8},{0,1,8},{0,0,9},
    {1,1,8},{0,0,8},{1,1,9},{0,0,8},{1,1,8},{0,0,9},{1,1,8},{0,0,8},
    {-4,0,9},{-3,0,8},{-3,0,8},{-1,0,8},{-2,0,9},{-1,0,8},{-2,0,8},{-1,0,8},
    {-2,0,9},{-1,0,8},{-2,0,8},{-1,0,8},{-3,-3,9},{-3,0,8},{-3,0,8},{-2,0,9},
    {-2,0,8},{-2,0,8},{-3,-1,9},{-2,0,8},{-3,0,8},{-2,0,9},{-3,0,8},{-2,0,8},
    {-5,-2,9},{-5,-1,8},{-3,-1,8},{-3,-1,8},{-3,-2,9},{-3,-1,8},{-3,-1,8},{-3,-2,8},
    {-4,-1,9},{-3,-1,8},{-4,-2,8},{0,0,8},{0,0,10},{-1,0,9},{-1,0,9},{-1,0,9},
    {-1,0,9},{-1,0,9},{-1,0,10},{-1,0,9},{-1,0,9},{-1,0,9},{-1,0,9},{-1,0,9}
};

static const TrackPoint GalilTrack[] = {
    {0,0,3},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},
    {0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},
    {1,0,6},{0,0,6},{0,0,6},{0,0,6},{0,0,5},{1,0,6},{0,0,5},{0,0,6},
    {0,1,5},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},{0,1,5},{0,0,6},
    {0,0,6},{0,0,6},{0,0,5},{0,0,6},{0,0,5},{0,0,6},{0,0,5},{0,0,6},
    {0,0,5},{0,0,6},{0,1,5},{0,0,6},{-1,1,5},{0,0,6},{-1,1,5},{0,0,6},
    {1,0,6},{0,1,6},{0,0,5},{1,1,6},{0,0,5},{0,1,6},{1,0,5},{0,1,6},
    {0,0,5},{1,1,6},{0,1,5},{0,0,6},{0,1,5},{1,1,6},{0,0,5},{0,1,6},
    {1,0,6},{1,1,6},{1,1,6},{1,1,6},{0,0,5},{1,1,6},{0,1,5},{1,1,6},
    {0,0,5},{1,1,6},{0,1,5},{1,1,6},{0,0,5},{1,1,6},{0,1,5},{1,1,6},
    {0,1,6},{0,1,6},{0,1,5},{0,1,6},{0,1,5},{0,1,6},{0,1,5},{0,1,6},
    {0,1,5},{0,1,6},{0,1,5},{0,1,6},{0,1,5},{0,1,6},{0,2,5},{0,1,6},
    {1,1,6},{0,1,6},{0,1,6},{0,1,6},{0,1,5},{0,1,6},{0,2,5},{0,1,6},
    {0,2,5},{0,1,6},{0,2,5},{0,1,6},{0,2,5},{0,1,6},{0,2,5},{0,1,6},
    {1,0,6},{0,1,6},{0,1,5},{1,1,6},{0,1,5},{0,1,6},{1,1,5},{0,1,6},
    {0,0,5},{1,1,6},{0,1,5},{0,1,6},{0,1,5},{1,1,6},{0,1,5},{0,1,6},
    {1,0,6},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},
    {0,1,5},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},
    {0,0,6},{0,1,6},{0,1,6},{0,0,6},{0,1,5},{0,1,6},{0,0,5},{0,1,6},
    {0,1,5},{0,0,6},{-1,1,5},{0,1,6},{-1,1,5},{0,0,6},{-1,1,5},{0,1,6},
    {-1,0,6},{-1,1,6},{-1,0,5},{-1,1,6},{-1,0,5},{-1,1,6},{-1,0,5},{-1,1,6},
    {-1,0,5},{-1,1,6},{-1,0,5},{-1,1,6},{-2,0,5},{-1,1,6},{-2,0,5},{-1,1,6},
    {-1,-1,6},{-2,0,6},{-1,0,6},{-2,0,6},{-1,-1,5},{-2,0,6},{-1,0,5},{-2,0,6},
    {-1,-1,5},{-2,0,6},{-2,0,5},{-1,0,6},{-2,-1,5},{-2,0,6},{-1,0,5},{-2,0,6},
    {-1,-1,6},{-2,-1,6},{-1,0,5},{-2,-1,6},{-1,0,5},{-2,-1,6},{-1,0,5},{-2,-1,6},
    {-1,0,5},{-2,-1,6},{-1,0,5},{-2,-1,6},{-1,0,5},{-2,-1,6},{-1,0,5},{-2,-1,6},
    {0,0,6},{-1,0,6},{0,0,5},{-1,0,6},{0,0,5},{-1,0,6},{0,1,5},{-1,0,6},
    {0,1,5},{-1,0,6},{0,1,5},{-1,0,6},{0,1,5},{-1,0,6},{0,1,5},{-1,0,6},
    {0,0,6},{-1,0,6},{0,0,6},{-1,0,6},{-1,0,5},{0,0,6},{-1,0,5},{-1,0,6},
    {0,0,5},{-1,0,6},{-1,1,5},{0,0,6},{-1,1,5},{-1,0,6},{0,1,5},{-1,0,6},
    {0,0,6},{0,0,6},{0,0,5},{0,0,6},{0,0,5},{0,0,6},{-1,0,5},{0,0,6},
    {-1,0,5},{0,0,6},{-1,0,5},{0,0,6},{-1,0,5},{0,0,6},{-1,0,5},{0,0,6},
    {0,0,6},{0,0,6},{0,0,6},{0,0,6},{0,0,5},{0,0,6},{0,0,5},{0,0,6},
    {0,0,5},{0,0,6},{0,0,5},{0,0,6},{0,0,5},{0,0,6},{0,1,5},{0,0,6},
    {1,0,6},{0,0,6},{0,0,5},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},
    {0,1,5},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},{0,1,5},{0,0,6},
    {2,0,6},{1,0,6},{2,0,5},{1,0,6},{1,1,5},{2,0,6},{1,1,5},{1,0,6},
    {2,1,5},{1,0,6},{1,1,5},{2,0,6},{1,1,5},{1,0,6},{2,1,5},{1,0,6},
    {1,0,6},{1,0,6},{1,0,6},{1,0,6},{1,0,5},{1,0,6},{0,0,5},{1,0,6},
    {0,0,5},{1,0,6},{0,0,5},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},
    {2,-1,6},{1,0,6},{1,0,5},{1,0,6},{2,0,5},{1,0,6},{1,0,5},{1,0,6},
    {2,-1,5},{1,0,6},{1,0,5},{1,0,6},{2,0,5},{1,0,6},{1,0,5},{1,0,6},
    {2,-1,6},{2,0,6},{1,-1,6},{2,0,6},{1,-1,5},{2,0,6},{1,-1,5},{2,0,6},
    {1,-1,5},{2,0,6},{1,0,5},{2,-1,6},{1,0,5},{2,0,6},{1,-1,5},{2,0,6},
    {1,0,6},{0,0,6},{0,0,5},{1,0,6},{0,0,5},{0,0,6},{1,0,5},{0,0,6},
    {0,0,5},{1,0,6},{0,0,5},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},
    {0,0,6},{-1,0,6},{0,0,5},{-1,0,6},{0,0,5},{-1,0,6},{0,0,5},{-1,0,6},
    {0,1,5},{-1,0,6},{-1,1,5},{0,0,6},{-1,1,5},{-1,0,6},{0,1,5},{-1,0,6},
    {1,-1,6},{1,0,6},{1,0,6},{1,0,6},{0,0,5},{1,-1,6},{0,0,5},{1,0,6},
    {0,0,5},{1,0,6},{0,0,5},{1,-1,6},{0,0,5},{1,0,6},{0,0,5},{1,0,6},
    {1,0,6},{1,0,6},{0,0,5},{1,0,6},{0,0,5},{1,0,6},{0,0,5},{1,0,6},
    {0,0,5},{1,0,6},{0,0,5},{1,0,6},{0,1,5},{1,0,6},{0,1,5},{1,0,6},
    {1,-1,6},{1,0,6},{1,0,6},{1,0,6},{1,0,5},{1,-1,6},{1,0,5},{1,0,6},
    {1,0,5},{1,0,6},{1,0,5},{1,-1,6},{0,0,5},{1,0,6},{0,0,5},{1,0,6},
    {0,0,6},{-1,0,6},{0,0,5},{-1,0,6},{0,0,5},{-1,0,6},{0,0,5},{-1,0,6},
    {0,0,5},{-1,0,6},{-1,0,5},{0,0,6},{-1,1,5},{-1,0,6},{0,1,5},{-1,0,6},
    {-1,-1,6},{-2,0,6},{-2,-1,5},{-1,0,6},{-2,0,5},{-2,-1,6},{-1,0,5},{-2,0,6},
    {-2,-1,5},{-1,0,6},{-2,0,5},{-2,-1,6},{-2,0,5},{-1,0,6},{-2,-1,5},{-2,0,6},
    {-1,-1,6},{-1,0,6},{-1,0,6},{-1,0,6},{-1,0,5},{-1,0,6},{-1,0,5},{-1,0,6},
    {-2,-1,5},{-1,0,6},{-2,0,5},{-1,0,6},{-2,0,5},{-1,0,6},{-2,0,5},{-1,0,6},
    {0,0,6},{-1,0,6},{-1,0,5},{-1,0,6},{0,0,5},{-1,0,6},{-1,1,5},{-1,0,6},
    {0,1,5},{-1,0,6},{-1,1,5},{-1,0,6},{0,1,5},{-1,0,6},{-1,1,5},{-1,0,6},
    {1,0,6},{0,0,6},{1,1,6},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},
    {1,1,5},{0,0,6},{0,1,5},{1,0,6},{0,1,5},{0,0,6},{1,1,5},{0,0,6},
    {0,-1,6},{-1,0,6},{-1,0,5},{-1,0,6},{0,0,5},{-1,-1,6},{-1,0,5},{-1,0,6},
    {0,0,5},{-1,0,6},{-1,0,5},{-1,-1,6},{0,0,5},{-1,0,6},{-1,0,5},{-1,0,6},
    {-1,-1,6},{-1,-1,6},{-1,-1,5},{-1,-1,6},{-1,-1,5},{-1,-1,6},{-1,0,5},{-1,-1,6},
    {-1,0,5},{-1,-1,6},{-2,0,5},{-1,-1,6},{-2,0,5},{-1,-1,6},{-2,0,5},{-1,-1,6},
    {0,-1,8},{-1,0,7},{-1,0,7},{-1,0,7},{0,0,7},{-1,0,7},{-1,0,7},{-1,0,7},
    {0,-1,8},{-1,0,7},{-1,0,7},{-1,0,7},{0,0,7},{-1,0,7},{-1,0,7},{-1,0,7}
};
static const TrackPoint M4A4[] = {
    {0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},{0,0,2},
    {0,0,1},{0,0,2},{0,0,1},{0,0,2},{0,0,8},{0,0,7},{0,0,8},{0,0,7},
    {0,0,8},{0,0,7},{0,0,8},{0,0,7},{0,0,8},{0,0,7},{0,0,8},{0,0,7},
    {1,1,8},{0,1,7},{0,1,8},{0,1,7},{0,1,8},{0,1,7},{0,1,8},{0,1,7},
    {0,1,8},{0,1,7},{0,2,8},{0,1,7},{0,1,8},{0,1,7},{0,1,8},{0,1,7},
    {-1,1,8},{0,1,7},{-1,1,8},{0,1,7},{-1,1,8},{0,1,7},{-1,2,8},{0,1,7},
    {1,1,8},{0,2,7},{0,1,8},{1,2,7},{0,1,8},{0,2,7},{1,2,8},{0,1,7},
    {0,2,8},{1,2,7},{0,1,8},{0,2,7},{0,1,8},{-1,2,7},{0,2,8},{-1,2,7},
    {0,1,8},{-1,2,7},{0,2,8},{-1,2,7},{0,1,8},{-1,2,7},{0,2,8},{-1,2,7},
    {0,1,8},{0,2,7},{0,1,8},{0,2,7},{0,1,8},{0,2,7},{-1,2,7},{0,1,8},
    {-1,2,7},{0,2,7},{-1,1,8},{0,2,7},{2,0,8},{1,1,7},{1,1,8},{1,1,7},
    {1,1,8},{1,1,7},{1,1,8},{1,1,7},{1,1,8},{1,1,7},{1,1,8},{1,1,7},
    {1,1,8},{1,1,7},{1,1,8},{1,1,7},{0,1,8},{1,1,7},{0,1,8},{1,1,7},
    {0,1,8},{1,1,7},{0,2,8},{1,1,7},{2,0,8},{2,0,7},{2,1,8},{2,0,7},
    {1,1,8},{2,0,7},{1,1,8},{2,0,7},{1,1,8},{2,0,7},{1,1,8},{2,0,7},
    {0,0,8},{-1,1,7},{0,0,8},{-1,1,7},{0,0,8},{-1,1,7},{0,1,8},{-1,0,7},
    {0,1,8},{-1,1,7},{0,0,8},{-1,1,7},{-1,0,8},{-1,0,7},{-1,0,8},{-1,0,7},
    {-1,1,8},{-1,0,7},{-2,1,8},{-1,0,7},{-2,1,8},{-1,0,7},{-2,1,8},{-1,0,7},
    {-1,0,8},{-2,0,7},{-2,0,8},{-2,0,7},{-2,0,8},{-2,0,7},{-1,0,8},{-2,0,7},
    {-2,0,8},{-2,0,7},{-2,0,8},{-2,0,7},{-1,-1,8},{-2,0,7},{-2,0,8},{-2,0,7},
    {-2,0,8},{-2,0,7},{-2,0,8},{-2,0,7},{-2,0,8},{-2,0,7},{-2,0,8},{-2,0,7},
    {-1,-1,8},{-2,-1,7},{-2,0,8},{-1,-1,7},{-2,0,8},{-2,-1,7},{-1,0,8},{-2,-1,7},
    {-2,0,8},{-1,-1,7},{-2,0,8},{-2,-1,7},{0,0,8},{0,0,7},{0,0,8},{0,0,7},
    {0,0,8},{0,0,7},{0,0,8},{0,0,7},{0,1,8},{0,0,7},{0,1,8},{0,0,7},
    {1,0,8},{0,1,7},{1,1,8},{0,0,7},{1,1,8},{0,1,7},{1,0,8},{0,1,7},
    {1,1,8},{0,0,7},{1,1,8},{0,1,7},{0,0,8},{-1,0,7},{-1,0,8},{-1,0,7},
    {0,0,8},{-1,0,7},{-1,0,8},{-1,0,7},{0,0,8},{-1,0,7},{-1,0,8},{-1,0,7},
    {0,-1,8},{-1,0,7},{-1,-1,8},{-1,0,7},{-1,-1,8},{-1,0,7},{0,0,7},{-1,-1,8},
    {-1,0,7},{-1,0,7},{-1,-1,8},{-1,0,7},{1,0,8},{0,0,7},{0,0,8},{0,0,7},
    {0,0,8},{0,0,7},{1,0,8},{0,0,7},{0,0,8},{0,0,7},{0,1,8},{0,0,7},
    {3,0,8},{2,0,7},{2,0,8},{2,0,7},{2,1,8},{2,0,7},{3,1,8},{2,0,7},
    {2,1,8},{2,0,7},{2,1,8},{2,0,7},{1,0,8},{1,0,7},{1,1,8},{1,0,7},
    {1,1,8},{1,0,7},{1,1,8},{1,0,7},{1,1,8},{1,0,7},{0,1,8},{1,0,7},
    {2,-1,8},{2,0,7},{2,0,8},{2,0,7},{2,0,8},{2,0,7},{2,0,8},{2,0,7},
    {1,0,8},{2,0,7},{1,0,8},{2,0,7},{1,0,8},{1,0,7},{0,0,8},{1,0,7},
    {0,0,8},{1,0,7},{0,0,8},{1,0,7},{0,0,8},{1,0,7},{0,1,8},{1,0,7},
    {1,0,8},{1,0,7},{1,1,8},{1,0,7},{1,1,8},{1,0,7},{0,1,8},{1,0,7},
    {0,1,8},{1,0,7},{0,1,8},{1,0,7},{0,0,8},{-1,0,7},{-1,0,8},{-1,0,7},
    {0,0,8},{-1,0,7},{-1,1,8},{-1,0,7},{0,1,8},{-1,0,7},{-1,1,8},{-1,0,7},
    {1,0,9},{0,0,8},{1,0,8},{0,0,9},{1,0,8},{0,0,8},{0,0,9},{1,0,8},
    {0,0,8},{0,0,9},{1,0,8},{0,0,8},{1,-1,8},{0,0,7},{0,0,8},{0,0,7},
    {1,0,8},{0,0,7},{0,0,8},{0,0,7},{1,0,8},{0,0,7},{0,0,8},{0,0,7},
    {1,0,8},{0,0,7},{0,0,8},{0,0,7},{0,1,8},{0,0,7},{1,1,8},{0,0,7},
    {0,1,8},{0,0,7},{0,1,8},{0,0,7},{1,0,9},{0,0,8},{1,0,8},{0,0,9},
    {1,0,8},{0,0,8},{0,1,9},{1,0,8},{0,1,8},{0,0,9},{1,1,8},{0,0,8}
};
    static const TrackPoint FAMAS[] = {
    {0,0,3},{0,0,3},{0,0,3},{0,0,3},{0,0,2},{0,0,3},{0,0,2},{0,0,3},
    {0,0,2},{0,0,3},{0,0,2},{0,0,3},{0,0,8},{0,0,7},{0,0,8},{0,0,7},
    {0,0,8},{0,0,7},{0,0,7},{0,0,8},{0,0,7},{0,0,7},{0,0,8},{0,0,7},
    {0,0,8},{0,1,7},{0,0,8},{0,1,7},{0,0,8},{0,1,7},{0,1,8},{0,0,7},
    {-1,1,8},{0,1,7},{-1,0,8},{0,1,7},{0,0,8},{0,1,7},{-1,1,8},{0,0,7},
    {-1,1,8},{0,1,7},{-1,0,8},{0,1,7},{-1,1,8},{0,0,7},{-1,1,8},{0,1,7},
    {0,1,8},{0,1,7},{0,1,8},{0,1,7},{0,1,8},{0,1,7},{0,1,7},{0,1,8},
    {0,2,7},{0,1,7},{-1,2,8},{0,1,7},{0,1,8},{0,1,7},{0,2,8},{0,1,7},
    {0,2,8},{0,1,7},{0,2,8},{0,1,7},{0,2,8},{0,1,7},{0,2,8},{0,1,7},
    {1,1,8},{1,1,7},{1,1,8},{1,1,7},{1,2,8},{1,1,7},{1,2,8},{1,1,7},
    {1,2,8},{1,1,7},{0,2,8},{1,1,7},{2,0,8},{1,1,7},{1,1,8},{1,1,7},
    {1,0,8},{1,1,7},{1,1,7},{1,1,8},{1,0,7},{1,1,7},{1,1,8},{1,1,7},
    {0,0,8},{0,1,7},{-1,1,8},{0,1,7},{-1,1,8},{0,1,7},{-1,0,8},{0,1,7},
    {-1,1,8},{0,1,7},{-1,1,8},{0,1,7},{-1,0,8},{-1,1,7},{-1,0,8},{-1,1,7},
    {-1,0,8},{-1,1,7},{-2,0,8},{-1,1,7},{-2,0,8},{-1,1,7},{-2,0,8},{-1,1,7},
    {-1,0,8},{-1,0,7},{-1,1,8},{-1,0,7},{-1,1,8},{-1,0,7},{-1,1,7},{-1,0,8},
    {-2,1,7},{-1,0,7},{-2,1,8},{-1,0,7},{0,0,8},{-1,0,7},{-1,0,8},{-1,0,7},
    {-1,0,8},{-1,0,7},{-1,0,8},{-1,0,7},{-1,1,8},{-1,0,7},{-1,1,8},{-1,0,7},
    {1,0,8},{0,0,7},{0,0,8},{1,0,7},{0,1,8},{0,0,7},{1,1,7},{0,0,8},
    {0,1,7},{1,0,7},{0,1,8},{0,0,7},{2,0,8},{2,0,7},{1,0,8},{2,0,7},
    {1,1,8},{2,0,7},{1,1,8},{2,0,7},{1,1,8},{2,0,7},{1,1,8},{2,0,7},
    {1,0,8},{1,0,7},{1,0,8},{1,0,7},{1,1,8},{1,0,7},{0,1,7},{1,0,8},
    {0,1,7},{1,0,7},{0,1,8},{1,0,7},{2,-1,8},{1,0,7},{1,0,8},{2,0,7},
    {1,-1,8},{1,0,7},{2,0,8},{1,0,7},{1,-1,8},{2,0,7},{1,0,8},{1,0,7},
    {1,0,8},{0,0,7},{1,0,8},{0,0,7},{1,0,8},{0,0,7},{0,0,8},{1,0,7},
    {0,0,8},{0,0,7},{1,1,8},{0,0,7},{1,0,8},{1,0,7},{1,0,8},{1,0,7},
    {1,0,8},{1,0,7},{1,0,7},{1,0,8},{1,0,7},{1,0,7},{1,0,8},{1,0,7},
    {1,0,8},{0,0,7},{0,0,8},{0,0,7},{1,1,8},{0,0,7},{0,1,8},{0,0,7},
    {1,1,8},{0,0,7},{0,1,8},{0,0,7},{0,0,8},{0,0,7},{0,0,8},{0,0,7},
    {-1,0,8},{0,0,7},{-1,0,8},{0,0,7},{-1,1,8},{0,0,7},{-1,1,8},{0,0,7},
    {-1,-1,7},{-2,0,7},{-2,0,7},{-1,0,7},{-2,0,7},{-2,0,7},{-1,0,6},{-2,0,7},
    {-2,0,6},{-1,0,7},{-2,0,6},{-2,0,7},{0,0,8},{0,0,7},{0,0,7},{0,0,7},
    {0,0,7},{0,0,7},{0,1,8},{0,0,7},{-1,1,7},{0,0,7},{-1,1,7},{0,0,7},
    {1,-1,8},{1,0,7},{1,0,8},{1,0,7},{1,0,8},{1,0,7},{0,0,8},{1,0,7},
    {0,0,8},{1,0,7},{0,0,8},{1,0,7},{1,-1,8},{1,0,7},{1,-1,8},{1,0,7},
    {1,-1,8},{1,0,7},{1,0,7},{1,-1,8},{1,0,7},{1,0,7},{1,-1,8},{1,0,7},
    {2,-1,10},{1,-1,10},{1,-1,10},{1,-1,10},{1,-1,10},{1,-1,10},{1,-1,10},{1,-1,10},
    {1,0,10},{1,-1,10},{1,0,10},{1,-1,10}
};

constexpr uint16_t AK47_LEN  = sizeof(AK47) / sizeof(AK47[0]);
constexpr uint16_t GALIL_LEN = sizeof(GalilTrack) / sizeof(GalilTrack[0]);
constexpr uint16_t M4A4_LEN  = sizeof(M4A4) / sizeof(M4A4[0]);
constexpr uint16_t FAMAS_LEN = sizeof(FAMAS) / sizeof(FAMAS[0]);   // ← 新增
...
void process_mapping(bool auto_repeat) {
    ...
    // ============================================================
    // 后坐力宏（AK47 / Galil / M4A4 三套弹道）
    //
    // 控制：
    //   B5 单击          装 AK47 弹道
    //   B5 双击 (<350ms) 装 M4A4 弹道
    //   中键             装 Galil 弹道
    //   B4               卸下，并立即沿原路退回起点
    //   左键按下         若已装弹则开始回放
    ...
    //
    // 实现要点：
    //   - 脉冲式发射：进入一步时一次性 accumulated += dx*1000，
    //     不分摊到 d 帧内，避开 Windows 鼠标加速对小幅高频运动的压制。
    //   - 回退用 120 帧平摊 + 最后一帧倾倒残余 milli，保证精度。
    //   - 双击检测：记录上次 B5 边沿时间戳，下次 B5 边沿若 <350ms
    //     则升级为 M4A4，否则保持 AK47。
    // ============================================================
    {
        ...
        // —— 装弹模式（互斥）——
        enum ArmedMode { ARMED_NONE, ARMED_AK47, ARMED_GALIL, ARMED_M4A4, ARMED_FAMAS };
        static ArmedMode armed = ARMED_NONE;
        ...
        // —— 双击检测：记录上次 B5 边沿时间戳 ——
        static uint64_t last_b5_edge_frame = 0;
        static bool last_b5_edge_valid = false;
        static uint64_t last_m_edge_frame = 0;
        static bool last_m_edge_valid = false;

        bool btn_l = p_btn_l && (*p_btn_l != 0);
        bool btn_m = p_btn_m && (*p_btn_m != 0);
        bool btn_4 = p_btn_4 && (*p_btn_4 != 0);
        bool btn_5 = p_btn_5 && (*p_btn_5 != 0);

        bool edge_l = btn_l && !prev_l;
        bool edge_m = btn_m && !prev_m;
        bool edge_5 = btn_5 && !prev_5;
        ...
        if (edge_l && armed != ARMED_NONE && !playing && !returning) {
            switch (armed) {
                ...
                case ARMED_GALIL:
                    cur = recoil::GalilTrack; cur_len = recoil::GALIL_LEN; break;
                case ARMED_M4A4:
                    cur = recoil::M4A4;       cur_len = recoil::M4A4_LEN;  break;
                case ARMED_FAMAS:
                    cur = recoil::FAMAS;      cur_len = recoil::FAMAS_LEN; break;
                default: break;
            }
            idx = 0;
            step_remain = 0;
